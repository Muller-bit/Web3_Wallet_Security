...
- Browser(small assets) and Hardware Wallets(large sum amount of money)
...
- a multi-sig wallet is a smart contract that governs txn .These can be setup so that ,they require several people to sign a txn for it to go through.
